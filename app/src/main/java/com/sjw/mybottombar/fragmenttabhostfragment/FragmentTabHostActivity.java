package com.sjw.mybottombar.fragmenttabhostfragment;
...
import static com.sjw.mybottombar.fragment.DataGenerator.mTabRes;
import static com.sjw.mybottombar.fragment.DataGenerator.mTabTitle;
    ...
    private void updateTabState(){
        ...
        for (int i=0;i<tabWidget.getTabCount();i++){
            ...
            if(i == mTabHost.getCurrentTab()){
                ...
                tabText.setTextColor(getResources().getColor(R.color.selectColor));
            }else{
                tabIcon.setImageResource(mTabRes[i]);
                tabText.setTextColor(getResources().getColor(R.color.unSelectColor));
            }
        }
    }
}
